...
<template>
    <Card class="py-24 sm:py-32">
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
            <h2 class="text-center text-lg leading-8 font-semibold text-foreground">Chosen by Forward-Thinking Enterprises</h2>
            <div
            ...
            >
                <img
                    ...
                    height="48"
                    :class="[
                        'col-span-2 max-h-12 w-full object-contain grayscale dark:invert',
                        index === 3 ? 'sm:col-start-2 lg:col-span-1' : index === 4 ? 'col-start-2 sm:col-start-auto lg:col-span-1' : 'lg:col-span-1',
                    ]"
                />
            </div>
        </div>
