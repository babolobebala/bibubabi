...
const pageBreadcrumbs = getModulePageBreadcrumbs(moduleNavigation as ModuleNavigationConfig, 'pst-admin');
</script>

<template>
    <ModuleContentShell body-variant="hub" :breadcrumbs="pageBreadcrumbs">
        <div class="rounded-lg border border-border bg-card p-4 text-sm text-muted-foreground">
            Halaman admin modul Pst.
        </div>
    </ModuleContentShell>
</template>
